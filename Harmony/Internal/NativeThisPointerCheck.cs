...
namespace HarmonyLib
{
    ...
    {
        internal static MethodInfo m_ArgumentShiftTranspiler =
            SymbolExtensions.GetMethodInfo(() => ArgumentShiftTranspiler(null));
        ...
        private static readonly IntPtr magicValue = (IntPtr) 0x12345678;
...
#pragma warning disable IDE0060
#pragma warning disable IDE0051
        private static void GetStructReplacement(NativeThisPointer self, IntPtr ptr, IntPtr a, IntPtr b)
#pragma warning restore IDE0051
#pragma warning restore IDE0060
        {
        ...
        private static IEnumerable<CodeInstruction> ArgumentShiftTranspiler(IEnumerable<CodeInstruction> instructions)
        {
            foreach (var instruction in instructions)
            {
                ...
                if (instruction.opcode == OpCodes.Ldarg || instruction.opcode == OpCodes.Ldarga ||
                    instruction.opcode == OpCodes.Ldarga_S || instruction.opcode == OpCodes.Starg ||
